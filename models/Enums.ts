...
export enum CallStatEvent{
   ...
   LOCAL_TRACK_STATE_CHANGED = 'LOCAL_TRACK_STATE_CHANGED',
   REMOTE_TRACK_STATE_CHANGED = 'REMOTE_TRACK_STATE_CHANGED',
   EVENT_CALL_STATE_CHANGED = 'EVENT_CALL_STATE_CHANGED',
   EVENT_CONNECTION_STATE_CHANGED = 'EVENT_CONNECTION_STATE_CHANGED',
   EVENT_ICE_CANDIDATE = 'EVENT_ICE_CANDIDATE',
   EVENT_ICE_CANDIDATE_ERROR = 'EVENT_ICE_CANDIDATE_ERROR',
   EVENT_ICE_CONNECTION_STATE_CHANGED = 'EVENT_ICE_CONNECTION_STATE_CHANGED',
   EVENT_ICE_GATHERING_STATE_CHANGED = 'EVENT_ICE_GATHERING_STATE_CHANGED',
   EVENT_NEGOTIATION_NEEDED = 'EVENT_NEGOTIATION_NEEDED',
   EVENT_SIGNALING_STATE_CHANGED = 'EVENT_SIGNALING_STATE_CHANGED',
