...
const dbModel = {
    ...
    specialization: { type: index_1.ObjectId, ref: 'specializations' },
    price: { type: Number },
    ...
    details: {
        type: {
            ...
            cut: Number,
            clinics: [{ type: index_1.ObjectId, ref: 'healthcenters' }],
            hospitals: [{ type: index_1.ObjectId, ref: 'healthcenters' }],
            response_days: {
                type: {
